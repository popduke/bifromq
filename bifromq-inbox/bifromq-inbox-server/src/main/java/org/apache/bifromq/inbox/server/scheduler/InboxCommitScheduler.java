...
@Slf4j
public class InboxCommitScheduler extends MutationCallScheduler<CommitRequest, CommitReply, BatchCommitCall>
    implements IInboxCommitScheduler {
    public InboxCommitScheduler(IBaseKVStoreClient inboxStoreClient) {
        super(BatchCommitCall::new, Duration.ofMillis(DataPlaneMaxBurstLatencyMillis.INSTANCE.get()).toNanos(),
            inboxStoreClient);
