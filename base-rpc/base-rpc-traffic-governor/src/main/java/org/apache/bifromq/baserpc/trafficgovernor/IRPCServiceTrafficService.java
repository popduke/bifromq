...
public interface IRPCServiceTrafficService extends AutoCloseable {
    ...
    Observable<Set<String>> services();

    IRPCServiceLandscape getServiceLandscape(String serviceUniqueName);

    IRPCServiceServerRegister getServerRegister(String serviceUniqueName);
