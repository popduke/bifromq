...
/**
 * The number of session registers which is controlling the internal rpc parallelism in SessionDictService.
 */
public class SessionRegisterNumber extends BifroMQSysProp<Integer, IntegerParser> {
