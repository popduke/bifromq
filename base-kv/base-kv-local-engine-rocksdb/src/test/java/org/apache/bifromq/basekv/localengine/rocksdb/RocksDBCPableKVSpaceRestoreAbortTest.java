...
public class RocksDBCPableKVSpaceRestoreAbortTest {
    private Path tmpRoot;
    private RocksDBCPableKVEngine engine;

    @BeforeMethod
    public void setup() throws Exception {
        tmpRoot = Files.createTempDirectory("kvspace_restore_abort_");
    }
    ...
    @Test
    public void testAbortNoEffectAndPointerUnchanged() throws Exception {
        String spaceId = "space_abort";
        ...
        session.put(ByteString.copyFromUtf8("k"), ByteString.copyFromUtf8("v"));
        session.abort();
