...
class BaseKVStoreBalancerStatesProposal implements IBaseKVStoreBalancerStatesProposal {
    private final IBaseKVStoreBalancerStatesProposalCRDT proposalCRDT;

    BaseKVStoreBalancerStatesProposal(IBaseKVStoreBalancerStatesProposalCRDT proposalCRDT) {
        this.proposalCRDT = proposalCRDT;
    }

    @Override
    public Observable<Map<String, BalancerStateSnapshot>> expectedBalancerStates() {
        return proposalCRDT.expectedBalancerStates();
    }
