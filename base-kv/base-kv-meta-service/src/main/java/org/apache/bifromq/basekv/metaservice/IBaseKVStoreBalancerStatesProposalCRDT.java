...
public interface IBaseKVStoreBalancerStatesProposalCRDT {
    ...
    Optional<BalancerStateSnapshot> expectedBalancerState(String balancerFactoryClassFQN);

    CompletableFuture<Void> setBalancerState(String balancerFactoryClassFQN, boolean disable, Struct loadRules);

    CompletableFuture<Void> removeBalancerState(String balancerFactoryClassFQN);
